...
class FmuService_create_instance_args {
 public:
  ...
  virtual ~FmuService_create_instance_args() noexcept;
  FmuId fmuId;
...
class FmuService_create_instance_pargs {
 public:
  ...
  virtual ~FmuService_create_instance_pargs() noexcept;
  const FmuId* fmuId;
...
class FmuService_create_instance_result {
 public:
  ...
  virtual ~FmuService_create_instance_result() noexcept;
  InstanceId success;
...
class FmuService_create_instance_presult {
 public:
  ...
  virtual ~FmuService_create_instance_presult() noexcept;
  InstanceId* success;
  UnsupportedOperationException ex1;
  NoSuchFmuException ex2;
...
class FmuService_freeInstance_args {
 public:
  ...
  virtual ~FmuService_freeInstance_args() noexcept;
  InstanceId instanceId;
...
class FmuService_freeInstance_pargs {
 public:
  ...
  virtual ~FmuService_freeInstance_pargs() noexcept;
  const InstanceId* instanceId;
...
class FmuService_freeInstance_result {
 public:
  ...
  virtual ~FmuService_freeInstance_result() noexcept;
  NoSuchInstanceException ex;
...
class FmuService_freeInstance_presult {
 public:
  ...
  virtual ~FmuService_freeInstance_presult() noexcept;
  NoSuchInstanceException ex;
...
class FmuServiceConcurrentClient : virtual public FmuServiceIf {
 public:
  FmuServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(prot);
  }
  FmuServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
