...
service FmuService {
    ...
    defs.ExportedState export_state(1: defs.StateIndex state_index) throws (1: defs.NoSuchInstanceException ex1, 2: defs.NoSuchVariableException ex2)
    defs.StateIndex import_state(1: defs.ExportedState exported_state) throws (1: defs.NoSuchInstanceException ex1, 2: defs.NoSuchVariableException ex2)
