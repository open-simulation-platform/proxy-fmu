...
if (FMILibrary_LIBRARY)
  if (NOT TARGET fmilib_::static)
    add_library("fmilib_::static" STATIC IMPORTED)
    set_target_properties("fmilib_::static" PROPERTIES
...
if (FMILibrary_SHARED_LIBRARY)
  if (NOT TARGET fmilib_::shared)
    add_library("fmilib_::shared" SHARED IMPORTED)
    set_target_properties("fmilib_::shared" PROPERTIES
            IMPORTED_LINK_INTERFACE_LANGUAGES "C"
            INTERFACE_INCLUDE_DIRECTORIES "${FMILibrary_INCLUDE_DIRS}")
    if (WIN32)
      set_target_properties("fmilib_::shared" PROPERTIES
...
if (FMILibrary_USE_SHARED_LIB)
  if (FMILibrary_SHARED_LIBRARY)
    set(FMILibrary_LIBRARIES "fmilib_::shared")
  endif ()
else ()
  if (FMILibrary_LIBRARY)
    set(FMILibrary_LIBRARIES "fmilib_::static")
  endif ()
endif ()
...
find_package_handle_standard_args(FMILibrary_ DEFAULT_MSG FMILibrary_LIBRARIES FMILibrary_INCLUDE_DIRS)