...
/*	fmi2_boolean_t loggingOn = fmi2_true; */
    ...
    printf("Platform typeAttribute returned:      %s\n", fmi2_import_get_types_platform(fmu));
...
int main(int argc, char *argv[])
{
    ...
    const char* FMUPath = "../fmus/2.0/cs/20sim/4.6.4.8004/ControlledTemperature/ControlledTemperature.fmu";
    const char* tmpPath = R"(E:\dev\osp\proxy-server\cmake-build-release\test)";
    ...
    fmu = fmi2_import_parse_xml(context, tmpPath, nullptr);
